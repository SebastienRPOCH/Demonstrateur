...
<body>
	...
	<div class="content">
		...
		<form method="post" action="createFil">
		<label for="nomFil"> Nom du Fil : <br /> <input
			type="text" name="nomFil" id="nomFil" maxlength="50"/>
		</label> <br /> <br /> <input type="submit" name="valider" value="Créer"/>
	</form>
